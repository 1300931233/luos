...
var ZYFILE = {
    ...
    funUploadFile: function (file) {
        ...
        if(dir!=null&&dir!=undefined&&dir!=""){
            formdata.append("Upload-dir", dir)
        }
        //此处是在资源附件批量上次处使用
        if(rafiRrcoId!=null&&rafiRrcoId!=undefined&&rafiRrcoId!=""){
            formdata.append("rafiRrcoId", rafiRrcoId)
        }
        console.log(dir);
        console.log(rafiRrcoId);
        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                    ...
                    html += '				<div id="status_info" class="info">选中 0 张文件，共 0B。</div>';
                    html += '				<div class="btns">';
            ...
            this.funDisposePreviewHtml = function (file, e) {
                ...
                var fileImgSrc = "module/zyupload/img/fileType/";
                if (type == "rar") {
                ...
                if (file.type.indexOf("image") == 0) {
                    ...
                    html += '	<a style="height:' + para.itemHeight + ";width:" + para.itemWidth + ';" href="#" class="imgBox">';
                    html += '		<div class="uploadImg" style="width:' + imgWidth + 'px">';
                    html += '			<img id="uploadImage_' + file.index + '" class="upload_file" src="' +ctxPath+ fileImgSrc + '" style="width:expression(this.width > ' + imgWidth + " ? " + imgWidth + 'px : this.width)" />';
                    html += "		</div>";
                    html += "	</a>";
                    html += '	<p id="uploadProgress_' + file.index + '" class="file_progress"></p>';
                    html += '	<p id="uploadFailure_' + file.index + '" class="file_failure">上传失败，请重试</p>';
