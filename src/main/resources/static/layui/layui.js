...
if (!Object.assign) {
    ...
    var components = {
        ...
        // 下拉选择
        xmSelect: "components/xm-select",
        // echarts图表扩展
        echarts: "components/echarts",
        // echarts图表主题扩展
        echartsTheme: "components/echartsTheme",
        // 数字步进器
        countUp: "components/countUp",
        // 条形码
        barcode: "components/barcode",
        // 二维码
        qrcode: "components/qrcode",
        // 通知公告
        layNotify: "components/layNotify",
        // 进度条
        nprogress: "components/nprogress",
        // 进度条
        cropper: "components/cropper",
        croppers: "components/croppers",
        // 省市区三级联动
        bioarea: "components/bioarea"
    };
